## 2026-09-18 (c) — The Activities step: SAP Activities, one heading per trade, and an activity that can be several
...
(main had reached `20260918c`) and sort-checked as a plain string across every token in the tree.
